...
from utils.utils import f_rsp, verify_request_body,api_log_start,api_log_end
...
class IndexHandler(BaseHandler):
    ...
    def post(self):
        ...
        self.write(dict(errcode=RET.OK, errmsg="OK", data=index_data))
        # 测试用例
